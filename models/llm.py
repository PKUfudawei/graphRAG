...
def get_llm(model="Qwen/Qwen3.5-27B", base_url="http://localhost:8000/v1", api_key="EMPTY", enable_thinking=False, **kwargs):
    """
    Args:
        model: 模型名称
        base_url: API 地址
        api_key: API 密钥
        enable_thinking: 是否启用思考模式，默认关闭 (False)，设为 True 开启
